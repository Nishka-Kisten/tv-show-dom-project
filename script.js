...
let epData = arr.map((ep)=> {
  ...
  rootElem.innerHTML = rootElem.innerHTML + epData; 
//Search for episodes
  ...
  search.addEventListener('keyup', (e) => {
      ...
      const filteredEp = arr.filter((ep) => {
        ...
        display.innerHTML = `Displaying ${filteredEp.length}/${allEpisodes.length} episodes.`
